		...
		<tr>
			<td align="right" valign="top">
				<table width="100%" border="0">
					<td width="8%" rowspan="4" align="center" valign="top"><img class="admin-logo" src="images/images.png" width="150" height="40" alt="Image" border="0" title="Images">&nbsp;</td>
					<tr>
		        ...
		        WHERE `tbl_admission`.`status` = '$visible' && `tbl_admission`.`admission_username` = '" . $_SESSION["logger_username1"] . "' && `tbl_allot_semester`.`type` = '2nd' ";
					...
					<tr>
						<td colspan="3" class="" align="center">&nbsp;&nbsp;<span class="admin">
								<ul style="margin-top: -30px;font-size: 16px;"><?php echo strtoupper($row_semester["semester"]) ?> Examination - <?php echo date('Y'); ?></ul>
							</span></td>
					</tr>
					<tr>
						<td colspan="3" class="" align="center">&nbsp;&nbsp;<span class="admin">
					...
					<tr>
						<td height="25" colspan="3" class="tb1_grid">&nbsp;&nbsp;<span class="admin" style="	word-spacing: -1px;">REGN NO: <?php echo $row["reg_no"] ?>&nbsp;&nbsp;&nbsp; COURSE: <?php
							...
							<table width="100%" class="">
									...
									<td>
										<table style="width:100%">
											<tr>
												...
												<td align="left" class="narmal" width="37%" style="text-transform: uppercase;"><?php echo $row["admission_first_name"] ?></td>
												...
												<th rowspan="3" style="width:100px; border: 1px solid #4d4a74"><?php
																							...
																							?>
								  <img width="71.3671875" height="87" alt="Image" border="0" title="Images" class="profile-user-img " src=<?php echo  ' "data:image/jpeg;base64,' . base64_encode($row["admission_profile_image"]) . '" ' ?>  alt="Student profile picture">
							  <?php
							  ...
							  <?php } ?></th>
											...
											<tr>
												...
												<td align="left" class="narmal" width="1%">:</td>
												<td align="left" class="narmal" width="20%" ;><?php echo $row["admission_dob"]; ?></td>
											</tr>
											<tr>
								...
								<tr colspan="3">
									<td>
										<table width="100%">
											<td class="narmal">CENTRE NAME: SRINATH UNIVERSITY, JAMSHEDPUR</br>ROLL NO: <?php echo $row["roll_no"] ?></td>
