...
?>
   <!-- <img src="images/marksheet/5e69c0b29bf625e69c0b29bf9d.png" alt="qr-code" height="100px"  />-->
			...
			<div class="tableText" >
			  ...
			  <p style="text-align: left;margin-left: -65px; line-height: 50%;"><b>NAME OF SCHOOL: </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_semester["name_of_school"] ?></p>
			  <p style="text-align: left;margin-left: -65px; line-height: 50%;"><b>NAME OF COURSE: </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_course["course_name"] ?></p>
			  ...
			  <p style="text-align: left;margin-left: -65px; line-height: 50%;"><b>EXAMINATION TYPE: </b>&nbsp;&nbsp;&nbsp;<?php echo $row["type"] ?></p>
