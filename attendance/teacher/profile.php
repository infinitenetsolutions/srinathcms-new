	...
	<div class="card">
		<form method="post" id="profile_form" enctype="multipart/form-data">
			...
			<div class="card-body">
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-8">
							<input disabled type="text" name="teacher_name" value="<?php echo $result[0]['teacher_name']; ?>" id="teacher_name" class="form-control" />
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-8">
							<textarea disabled name="teacher_address" id="teacher_address" class="form-control"><?php echo $result[0]['teacher_address']; ?></textarea>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-8">
							<input disabled type="text" name="teacher_emailid" id="teacher_emailid" value="<?php echo $result[0]['teacher_emailid']; ?>" class="form-control" />
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-8">
							<input disabled type="password" name="teacher_password" value="<?php echo $result[0]['teacher_password']; ?>" id="teacher_password" class="form-control" placeholder="Leave blank to not change it" />
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-8">
							<input disabled type="text" name="teacher_qualification" value="<?php echo $result[0]['teacher_qualification']; ?>" id="teacher_qualification" class="form-control" />
				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<span class="text-danger"><?php // echo $error_teacher_grade_id; 
													?></span>
					</div>
				</div>
			</div> -->
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-8">
							<input disabled type="text" value="<?php echo $result[0]['teacher_doj']; ?>" name="teacher_doj" id="teacher_doj" class="form-control" readonly />
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-8">
							<!-- <input disabled  type="file" name="teacher_image" id="teacher_image" /> -->
							<img src="./teacher_image/<?php echo $result[0]['teacher_image'];  ?>" class="profilelogo" alt="">
			...
			<div class="card-footer" align="center">
				<input disabled type="hidden" name="hidden_teacher_image" id="hidden_teacher_image" />
				<input disabled type="hidden" name="teacher_id" id="teacher_id" />
				<a href="logout.php" class="btn btn-success">Logout</a>
				<!-- <input disabled type="submit" name="button_action" id="button_action" class="btn btn-success btn-sm" value="Save" /> -->
			</div>
		</form>
	</div>
</div>
