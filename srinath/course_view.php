...
// //  i have to riciving the data of course 
// $prospectus_fee= $_POST['prospectus_fee'];
// $course_name= $_POST['add_course_name'];
// $insert_course="INSERT INTO `tbl_course`(`course_name`, `prospectus_rate`, `course_time`, `status`) VALUES ('$course_name','$prospectus_fee','[value-4]','[value-5]')";
...
<head>
    ...
    <title>Srinath UNIVERSITY | Courses </title>
    <!-- Fav Icon -->
